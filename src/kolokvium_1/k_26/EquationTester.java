...
public class EquationTester {
    public static void main(String[] args) {
        ...
        if (testCase == 1) { // Testing with Integer, Integer
            ...
            equations1.add(new Equation<>(() -> inputs.get(2), s -> inputs.get(2) + 1000));
            ...
            equations1.add(new Equation<>(() -> inputs.get(1), s -> Math.max(inputs.get(1), 100)));
            ...
            equations2.add(new Equation<>(() -> inputs.get(0), s -> inputs.stream().filter(i -> i.calculateLine() > inputs.get(0).calculateLine()).mapToDouble(Line::calculateLine).sum()));
